# Projet Web : 1er Bal des Lionceaux

Site pour un bal fictif.

## Points Techniques (Barème)
- **Zéro Librairie :** HTML5 / CSS3 / JS natif uniquement.
- **Sémantique :** Utilisation de balises `<header>`, `<nav>`, `<section>`, `<footer>`.
- **CSS Moderne :** Flexbox et `backdrop-filter: blur()`.
